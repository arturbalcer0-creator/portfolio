  ...
  return (
    <section id="solutions" className="flex w-full flex-col items-center pt-[80px]">
      ...
      <div className="w-full px-[16px] lg:px-[30px]">
        <div className="flex w-full flex-col items-center gap-[32px] rounded-[var(--radius-lg)] bg-[var(--black)] px-[16px] py-[48px] text-[color:var(--white)] lg:flex-row lg:gap-[24px] lg:rounded-[var(--radius-2xl)] lg:px-[140px] lg:py-[100px]">
          <PainSolution
            painsLabel="Боли"
      ...
      <div className="mt-[24px] w-full px-[16px] pb-[80px] lg:mt-[30px] lg:px-[30px] lg:pb-[160px]">
        <div className="flex w-full flex-col items-center gap-[32px] rounded-[var(--radius-lg)] bg-[var(--green-700)] px-[16px] py-[48px] text-[color:var(--white)] lg:flex-row lg:gap-[24px] lg:rounded-[var(--radius-2xl)] lg:px-[140px] lg:py-[100px]">
          <PainSolution
            painsLabel="Боли"
            pains={[
